---
title: "amy-jung/collectivedaoarchives.catalog: The Collective DAO Catalog is an open source index of DAO historical events. Together, as an open source database that anyone can contribute to, we can use the power of collective intelligence to highlight patterns and improve the development of new and existing DAOs"
source: "https://github.com/amy-jung/collectivedaoarchives.catalog"
author:
  - "[[GitHub]]"
published:
created: 2026-03-20
description: "The Collective DAO Catalog is an open source index of DAO historical events. Together, as an open source database that anyone can contribute to, we can use the power of collective intelligence to highlight patterns and improve the development of new and existing DAOs - amy-jung/collectivedaoarchives.catalog"
tags:
---
...
- Deployed to Heroku: [https://dao-catalog-api-5a6466df16c9.herokuapp.com/](https://dao-catalog-api-5a6466df16c9.herokuapp.com/)

**Frontend** (packages/frontend):

- Reads data from the backend API and shows it in a web interface.
- Built with NextJS.
- Deployed to Vercel: [https://collectivedaoarchives-catalog.vercel.app/](https://collectivedaoarchives-catalog.vercel.app/)
