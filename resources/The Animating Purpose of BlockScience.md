...
Specifying our animating purpose beyond this general form requires us to look more closely at its components, beginning with our mission. Upon closer examination, our mission statement has three primary elements: It frames the **core challenge** that our organization seeks to address, identifies the **methodology** we will apply in order to address it, and indicates **how we define success** — that is, the set of conditions that we feel must be metin order for us to deem a project successful.

![](https://miro.medium.com/v2/resize:fit:700/0*0EJ3Jv-A9_VhAeDx)

A graph demonstrating the capability gaps and time lags between “bleeding edge” tech that pushes new boundaries, and reliable tech that provides technical capabilities without the additional sources of uncertainty and risk.
