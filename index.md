...
> The resources gathered here, as well as the results from Harmonica, have been combined into a single leaderboard. You can explore it below. 
>
> **[View Live Leaderboard →](https://govacc.net/deliberate/leaderboard)**

> [!abstract] Phase 1 Preliminary Harmonica Findings
> Preliminary results from our Harmonica structured interviews — 52 conversations mapping 11 governance problems, 41 proposed solutions, and 59 actors across the ecosystem. Phase 1 research is ongoing with additional data sources.
>
